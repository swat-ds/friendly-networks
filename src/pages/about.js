    ...
    <Layout>
      ...
      <Col className="background-col">
        <Card bg="primary" className="general-text background">
          ...
          <p>Instead, the project site primarily draws on data stored in robust institutional platforms. All EAC-CPF records for the project are hosted on <a href="https://snaccooperative.org" target="_blank" rel="noreferrer">SNAC</a>, where they are broadly discoverable by researchers and available for reuse by other archivists. The data is pulled into the project site through the SNAC API. Similarly, images of Hunt and Evans&rsquo;s journals are hosted on Swarthmore College&rsquo;s <a target="_blank" rel="noreferrer" href="https://digitalcollections.tricolib.brynmawr.edu">Digital Collections platform</a> and displayed on the <i>Friendly Networks</i> site via IIIF. The only data unique to the site is the text of the digital editions, which is encoded using the <a href="https://tei-c.org/" target="_blank" rel="noreferrer">TEI standard</a>. Even this may eventually be moved to the Digital Collections platform.</p>
          <p>The project site itself is built in GatsbyJS and was architected by digital scholarship librarian Nabil Kashyap and student developer Zakir Hossain &lsquo;24, with significant further work by project lead James Truitt. The <Link to="/network">network visualization</Link> is built using <a href="https://d3js.org/" target="_blank" rel="noreferrer">d3.js</a>. The digital editions are rendered via <a href="https://openseadragon.github.io/" target="_blank" rel="noreferrer">OpenSeadragon</a> for the page images and <a href="https://teic.github.io/CETEIcean/" target="_blank" rel="noreferrer">CETEIcean</a> for the text.</p>
          </Card.Body>
        </Card>
      </Col>
      </Row>
