...
const Network = ({ nodesInJSON, linksInJSON, centralFigure}) => {
  ...
  let noHuntLinks = [];
   ...
   useEffect(() => {
     let filtered = getNodesWithoutHunt(nodesInJSON, linksInJSON, centralFigure);
     noHuntNodes = filtelet filtered.noHuntNodes;
     noHuntLinks = filtelet filtered.noHuntLinks
   }, []);
