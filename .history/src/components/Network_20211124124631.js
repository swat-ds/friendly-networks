...
const Network = ({ nodesInJSON, linksInJSON, centralFigure}) => {
  //states to changes nodes and links if needed
   ...
   useEffect(() => {
     let filteredData = getNodesWithoutHunt(
       nodesInJSON,
       linksInJSON,
       centralFigure
     );
     console.log(filteredData);
     setNoHuntNodes(filteredData.noHuntNodes);
     setNoHuntLinks(filteredData.noHuntLinks);
   }, []);

   console.log("nodes in json length:", nodesInJSON.length);
    console.log("links in json length:", linksInJSON.length);
    console.log("no Hunt nodes legth:", noHuntNodes.length);
    console.log("no Hunt links in json length:", linksInJSON.length);
   console.log(noHuntNodes)
   console.log(noHuntLinks)
